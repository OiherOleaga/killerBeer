...
<body class="bg-lightdark">
    ...
    <main class="h-screen">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span
                                class="ms-1 text-md font-medium text-fourth md:ms-2 dark:text-gray-400">Pedidos</span>
                        </div>
                    </li>
                </ol>
            </nav>
                ...
                <tbody>
                    @foreach ($pedidos as $pedido)
                        <tr class=" bg-lightdark">
                            ...
                            <td class="px-6 py-4">{{ $pedido->id_cliente }}</td>
                            <td class="px-6 py-4">{{ $pedido->estado }}</td>
                            <td class="px-6 py-4">{{ $pedido->fecha_entrega }}</td>
        ...
        <div class=" w-full flex items-center justify-center mb-4">
            <a href="{{ route('pedidos.create') }}" class="relative inline-block text-lg group">
                <span
                    ...
                    <span class="relative">+ Añadir Pedido</span>
                </span>
                <span class="absolute bottom-0 right-0 w-full h-12 -mb-1 -mr-1 transition-all duration-200 ease-linear bg-fourth rounded-lg group-hover:mb-0 group-hover:mr-0"
