...
<template>
    <section class="store overflow-hidden">
        ...
        <div class="row">
            <div class="col">
                <div class="col beers">
                    <h1 class="display-2 text-center">CERVEZAS 0'0</h1>
                    <section class="d-flex flex-wrap justify-content-center align-items-center gap-5 text-center py-3">
                        <div class="card col-10 col-lg-3 d-flex justify-content-center align-items-center">
                            <img src="../components/img/beers/Leonardo_Diffusion_XL_crea_una_lata_de_cerveza_llamada_KillerB_0 (1).jpg"
                                class="card-img-top" alt="green iguana" />
        ...
        <div class="row">
            <div class="col">
                <div class="col beers">
                    <h1 class="display-2 text-center">RADLER</h1>
                    <section class="d-flex flex-wrap justify-content-center align-items-center gap-5 text-center py-3">
                        <div class="card col-10 col-lg-3 d-flex justify-content-center align-items-center">
                            <img src="../components/img/beers/Leonardo_Diffusion_XL_crea_una_lata_de_cerveza_llamada_KillerB_0 (1).jpg"
                                class="card-img-top" alt="green iguana" />
        ...
        <div class="row">
            <div class="col">
                <div class="col beers">
                    <h1 class="display-2 text-center">RADLER 0'0</h1>
                    <section class="d-flex flex-wrap justify-content-center align-items-center gap-5 text-center py-3">
                        <div class="card col-10 col-lg-3 d-flex justify-content-center align-items-center">
                            <img src="../components/img/beers/Leonardo_Diffusion_XL_crea_una_lata_de_cerveza_llamada_KillerB_0 (1).jpg"
                                class="card-img-top" alt="green iguana" />
        ...
        <div class="row">
            <div class="col">
                <div class="col beers">
                    <h1 class="display-2 text-center">AGUA</h1>
                    <section class="d-flex flex-wrap justify-content-center align-items-center gap-5 text-center py-3">
                        <div class="card col-10 col-lg-3 d-flex justify-content-center align-items-center">
                            <img src="../components/img/beers/Leonardo_Diffusion_XL_crea_una_lata_de_cerveza_llamada_KillerB_0 (1).jpg"
                                class="card-img-top" alt="green iguana" />
